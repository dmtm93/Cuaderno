            ...
            {editingId === c.id ? (
              ...
              <>
                ...
                <div className="flex gap-1 ml-2 shrink-0">
                  ...
                  <button className="icon-btn icon-btn-danger" title="Cut" onClick={() => deleteCard(c.id)}>
                    <CutIcon />
                  </button>
                </div>
              </>
...
function CutIcon() {
  // A broad, flat blade — unusually wide relative to its length, the way a
  // certain oversized fantasy sword tends to be drawn. Reads as a plain
  // blade/cut icon at this size; the proportions are the whole joke.
  return (
    <svg viewBox="0 0 24 24" width="13" height="13" fill="currentColor" aria-hidden="true">
      <path d="M8.3 1.2 L15.7 1.2 L15.2 14.5 L12 19 L8.8 14.5 Z" />
      <rect x="5.5" y="14.5" width="13" height="1.8" rx="0.6" />
      <rect x="11" y="16.3" width="2" height="4.2" rx="0.4" />
      <circle cx="12" cy="21.3" r="1.15" />
    </svg>
  );
}
